...
pure intel 4xkernel capture - good and comparable to modesetting driver
pure intel 4xkernel local - perfect wth no tearing better than modesetting
pure intel 4xkernel stream - same horrible speed with falkon and chromium
...
340xx - kernel5x - module build errors
390xx - kernel5x - xlib extension glx missing on display
basic - kernel5x - working but not quite fast enough
340xx - kernel4x - xlib extension glx missing on display
